...
// -- CUSTOM --
// -- Indirection offsets --
#define BS get_block_size()

#define directSize			12
#define fstIndSize			BS
#define sndIndSize			BS*BS

#define directOffset		12
#define fstIndOffset		fstIndSize + directOffset
#define sndIndOffset		sndIndSize + fstIndOffset
...
public:
	...
	unsigned int indirect_once(unsigned int lba, unsigned int index);
