...
#define TAG_PEDIDO_CLI        20    /* cli -> srv */
#define TAG_OTORGADO          30    /* srv -> cli */
#define TAG_LIBERO            40    /* cli -> srv */
#define TAG_TERMINE           50    /* cli -> srv */
// Entre servidores. Son el REQUEST y el REPLY
#define TAG_PEDIDO_SRV        60    /* srv -> srv */
#define TAG_HABILITAR         70    /* srv -> srv */
#define TAG_FINALIZAR         80    /* srv -> srv */
#define TAG_ACK_FINALIZAR     90    /* srv -> srv */
